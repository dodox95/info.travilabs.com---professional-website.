  ...
  slides: [
    {
      images: [
        ...
        },
        {
          title: 'title',
          path: '/instagram.jpg',
          url: 'https://www.instagram.com/travilabs_/',
          hoverText: 'Instagram content',
        },
        {
          title: 'title',
          path: '/twitter.jpg',
          url: 'https://twitter.com/travilabs',
          hoverText: 'X/Twitter content',
        },
      ],
    },
...
const EducationSlider = () => {
  return ( 
    ...
    >
      {educationSlider.slides.map((slide, indexSlide) => {
        return (
